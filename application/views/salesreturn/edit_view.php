...
<form action="<?php echo site_url('salesreturn/salesreturn/edit'); ?>" method="post" class="form-horizontal custom-form" role="form">
    <!--main content start-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-md-offset-2">
                                    ...
                                    <div class="final-submit pull-right">
                                        <button type="submit" id="updatesalererurn" class="btn btn-default">Update</button>
...
<?php $this->sessiondata = $this->session->userdata('logindata'); ?>
    $(document).ready(function () {
        ...
        if (userrole == 'r') {
            $("#updatesalererurn").prop("disabled", true);
        }
    });
</script>
