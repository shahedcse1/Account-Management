...
<form action="<?php echo site_url('purchasereturn/purchase_return/add'); ?>" method="post" class="form-horizontal custom-form" role="form">
    <!--main content start-->
        ...
        <section class="wrapper site-min-height">
            ...
            <section class="panel">
                <header class="panel-heading">
                    Add  Purchase Return Information
                </header>
                    ...
                    <div class="adv-table">
                        ...
                        <div class="row purchase-top">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="col-md-8 myselect">
                                    <select class="form-control selectpicker" data-live-search="true" name="invoive_number" id="invoive_number" required>
                                        <option value="">Select</option>
                                        <?php
                                        if(isset($purchaseinfo)){
                                            foreach($purchaseinfo as $purchase){
                                                    echo '<option value="'.$purchase->purchaseInvoiceNo.'">'.$purchase->purchaseInvoiceNo.'</option>';
                                            }
                                        }?>
                                    </select>
                                </div>
