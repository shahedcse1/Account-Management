            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('paymentvoucher/paymentvoucher/addpayment') ?>">
                            <div class="col-lg-6">                                
                                <div class="form-group">
                                    <label for="paymentMode" class="col-lg-5 col-sm-2 control-label">Cash/Bank Account</label>
                                    <div class="col-lg-6">                                        
                                        <select class="form-control" id="paymentMode" name="" type="text" data-live-search="true" onchange="return setpaidto()" required>
                                        </select>
                                        <span id="grpmsg"></span>
                                    </div>  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">                                       
                                        <select class="form-control" id="ledgerId" name="ledgerId" data-live-search="true" type="text" onchange="GetBusinessName()" required>
                                        </select>    
                            ...
                            <div class="panel-body">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <input class=" form-control" id="paymentvouModal" name="paymentvouModal"  type="hidden"  value="addpaymentvouModal"/>
                        ...
                        <form class="cmxform form-horizontal tasi-form" id="aganstfrm" name="aganstfrm" method="post" action="">
                            ...
                            <div class="panel-body">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-8">                                       
                                        <select class="form-control" id="voucherType" name="voucherType" type="text">
...
<script>
    $(document).ready(function() {
        ...
        $("#paymentvoutersubmit").click(function() {
            ...
            if(paymentMode == ""){
                $("#grpmsg").text("Please select account!").css("color", "red");
                return false;
            } else if (ledgerId == ""){
                $("#grpmsg").text("");
