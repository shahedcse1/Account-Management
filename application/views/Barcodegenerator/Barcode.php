<section id="main-content" >
    <section class="wrapper site-min-height">
        <section class="panel">
            ...
            <form class="cmxform form-horizontal tasi-form" method="post" action="<?php echo site_url('Barcodegenerator/baecode') ?>">
                <br/>
                <div class="panel-body"> 
                    <div class="form-group ">
                        <label for="input Data" class="control-label col-lg-4">Input Data:</label>
                        <div class="col-lg-6">
