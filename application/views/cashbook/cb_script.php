...
//        }
        ...
        if (navigator.appName == "Microsoft Internet Explorer") {
            ...
            var currentdate = d.getFullYear() + '-' +
                    ...
                    (('' + day).length < 2 ? '0' : '') + day;
            var outputFile = "cash_book_report" + "_" + currentdate;
...
//        var selected_val = document.querySelector('input[name="bank_book_radio"]:checked').value;
        ...
        doc.text(200, 20, "Details Report For Cash Book");
    ...
    function Clickheretoprint()
    {
        ...
        docprint.document.write('<html><title>Details Report Of Cash Book</title>');
        ...
        docprint.document.write('<p style="margin-left:80px">Details Report for Cash Book</p>');
