...
<script type="text/javascript">
    ...
    function generatePdf() {
        ...
        doc.text(200, 20, "Details Report For Balance Sheet");
    ...
    function Clickheretoprint()
    {
        ...
        docprint.document.write('<html><title>Details Report Of Balance Sheet</title>');
        ...
        docprint.document.write('<p style="margin-left:80px">Details Report for Balance Sheet</p>');
