...
<script type="text/javascript">
    ...
    $("#btnExport ").on('click', function(event) {
        ...
        if (navigator.appName == "Microsoft Internet Explorer") {
            ...
            var currentdate = d.getFullYear() + '-' +
                    ...
                    (('' + day).length < 2 ? '0' : '') + day;
            var outputFile = "trail_balance_report" + "_" + currentdate;
    ...
    function Clickheretoprint()
    {
        ...
        docprint.document.write('<html><title>Details Report Of Trail Balance</title>');
        ...
        docprint.document.write('<p style="margin-left:80px">Details Report for Trail Balance</p>');
