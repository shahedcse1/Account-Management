        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        <form class="tasi-form" method="post" action="<?php echo site_url('trialbalance/trialbalance2'); ?>">
                                ...
                                <div class="col-md-5" style="padding-left: 0">
                                    <div class="input-group input-sm" >
                                        ...
                                        <div class="iconic-input right">
                                            ...
                                            <input id="datetimepickerfrom" type="text" class="form-control" name="date_from"
                                                   value="<?php echo $date_from; ?>">
                                        </div>
                                        <span class="input-group-addon">To</span>
                                        <div class="iconic-input right">
                                            <i class="fa fa-calendar"></i>
                                            <input id="datetimepickerto" type="text" class="form-control" name="date_to" 
