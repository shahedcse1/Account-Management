    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                Stock Information Import From Excel
            </header>
            ...
            <div class="panel-body">
                <div class="adv-table">
                    <div class="clearfix">
                        <form class="tasi-form" method="post" enctype="multipart/form-data" action="<?php echo site_url('stockentry/stockentryimport/importdatadb'); ?>">
