...
<form action="<?php echo site_url('stockentry/stockentry/add'); ?>" method="post" class="form-horizontal custom-form" role="form">
<!--main content start-->
            ...
            <div class="panel-body">
                <div class="adv-table">
                    ...
                    <hr/>
                            ...
                            <div class="form-group col-md-4">
                                <label for="sale_rate" class="col-md-4 control-label custom">Sale Rate</label>
                                <div class="col-md-8">
