<script>
    ...
    $("#addpurchase").click(function() {
        ...
        var datastringbasic = 'ledgerid=' + ledgerid + '&edate=' + dateval;
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('productdistribute/productdistribute/accountBasicInfo'); ?>",
        ...
        var dataString = "count=" + count + "&product_name=" + product_name + "&qty=" + qty + "&unit=" + unit + "&rate=" + rate;

        $.ajax({
            type: "POST",
            url: "<?php echo site_url('productdistribute/productdistribute/add_view_table'); ?>",
            data: dataString,
            success: function(data) {
    ...
    $("#discountpercantage").change(function() {
        ...
        var discountamount = ((discountper * net_amount) / 100);
    ...
    $("#product_name").change(function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('productdistribute/productdistribute/product_description'); ?>",
            data: dataString,
            success: function(data) {
                if (data == "") {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('productdistribute/productdistribute/unit_name'); ?>",
            data: dataString,
            success: function(data) {
                var res = data.split(",");
                $("#unitshow").val(res[1]);
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('productdistribute/productdistribute/product_salerate'); ?>",
            data: dataString,
            success: function(data) {
                $("#rate").val(data);
            }
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('productdistribute/productdistribute/product_qty'); ?>",
            data: dataString,
            success: function(data) {
                var range = data;
                if (range == "") {
