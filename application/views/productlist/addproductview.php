        ...
        <section class="panel">            
            <div class="panel-body">
                <form class="cmxform form-horizontal"
                      id="unitgroupadd"
                      method="post"
                      action="<?=site_url('productlist/product/addproduct'); ?>"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" id="prodcodediv" style="display: none">
                            <label for="productCode" class="control-label col-lg-4">Product Code :</label>
                            <div class="col-lg-8">
                                <input class=" form-control"
                                       id="productCode"
                                       name="productCode"
                                       type="text"
                                       onchange="return name();" />
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control" id="manufactureId" name="manufactureId" required >
