                ...
                foreach ($databyid as $unitvalue):
                    ...
                    <div class="col-lg-7" style="margin-top: 20px;">
                        <section class="panel">
                            ...
                            <form class="cmxform form-horizontal" id="unitgroupedit" method="post" action="<?php echo site_url('productlist/product/editproduct'); ?>" enctype="multipart/form-data">
                                <div class="panel-body">
                                ...
                                <div class="modal-footer" style="text-align: center">
                                    <input type="submit" id="updateproduct" class="btn btn-primary" value="Update"/>&nbsp;&nbsp;&nbsp;                                  
