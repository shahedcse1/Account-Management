...
<section id="main-content">
    <section class="wrapper site-min-height">    
        <section class="panel">
                ...
                <div class="adv-table">
                    <div class="clearfix">
                        <div class="btn-group pull-right">
                            <a href="<?php echo site_url('productlist/rawproduct/add_view_rawProduct'); ?>">
                    ...
                    <table  class="display table table-bordered table-striped" id="cloudAccounting">
                        ...
                        <tbody>
                            <?php
                            if (sizeof($rawProductList) > 0):
                                foreach ($rawProductList as $rows):
                                    ?>
                                    <tr class="table_hand">
                                        <td><a data-toggle="modal" href="#unitdelete<?php echo $rows->productId ?>">
                                                <i class="fa fa-times-circle delete-icon"></i></a>
                                        </td>
                                        <td class="clickable"><a href="<?php echo site_url('productlist/rawproduct/edit_view_rawProduct/' . $rows->productId) ?>"><img src="<?php echo base_url('assets/uploads/product/' . $rows->images) ?>" width="25" height="20" style="border-radius: 50%"></a></td>
                                        <td class="clickable"> <a href="<?php echo site_url('productlist/rawproduct/edit_view_rawProduct/' . $rows->productId) ?>"><?php echo $rows->productName ?></a></td>
                                        <td class="clickable"> <a href="<?php echo site_url('productlist/rawproduct/edit_view_rawProduct/' . $rows->productId) ?>"><?php echo $rows->description ?></a></td>                                      
                                        <td class="clickable"> <a href="<?php echo site_url('productlist/rawproduct/edit_view_rawProduct/' . $rows->productId) ?>">
                                                <?php
                                        ...
                                        <td class="clickable"> <a href="<?php echo site_url('productlist/rawproduct/edit_view_rawProduct/' . $rows->productId) ?>"><?php echo $salesRate ?></a></td>                                                                         
            ...
            <?php
            if (sizeof($rawProductList) > 0):
                foreach ($rawProductList as $unitvalue):
                    ?>
                    <div class="modal fade" id="unitdelete<?php echo $unitvalue->productId ?>" tabindex="-1" role="dialog" aria-labelledby="unitdelete" aria-hidden="true">
                        <div class="modal-dialog">
                            <form class="cmxform form-horizontal tasi-form" id="delaccgroup" method="post" action="<?php echo site_url('productlist/rawproduct/delete_rawProduct') ?>">
