...
<form action="<?php echo site_url('damagestock/damagestock/edit'); ?>" method="post" class="form-horizontal custom-form" role="form">
<!--main content start-->
...
<section class="panel">
    ...
    <div class="panel-body">
        <div class="adv-table">
            ...
            <?php if(isset($damagestcokinfo)):
            foreach($damagestcokinfo as $damagestcok):?>
            <div class="row purchase-top">
                <input  id="company_id"  name="company_id" type="hidden" value="<?php echo $company_id;?>"/>
                <input  id="damageStockMasterId"  name="damageStockMasterId" type="hidden" value="<?php echo $this->input->get('id');?>"/>

                <div class="form-group col-sm-4">
                    <label for="invoice_data" class="col-sm-4 control-label text-left"> Date</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="invoice_date" value="<?php echo $damagestcok->date;?>" id="datetimepicker" readonly/>
                    </div>
                </div>
                ...
                <tbody id="addnewrowedit">
                    <?php if(isset($productinfo)):
                        ...
                        <tr class="single_row" id="<?php echo $count;?>">
                            <td>
                                <?php  //product name
                                echo  '<input name="damageStockDetailsId'.$count.'" id="damageStockDetailsId'.$count.'" value="'.$rqv->damageStockDetailsId.'" type="hidden"/>';
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="description" id="description" cols="30" rows="5"><?php echo $damagestcok->description;?></textarea>
                            </div>
                        </div>
