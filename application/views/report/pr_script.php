...
//        }
        ...
        if (navigator.appName == "Microsoft Internet Explorer") {
            ...
            var currentdate = d.getFullYear() + '-' +
                    ...
                    (('' + day).length < 2 ? '0' : '') + day;
            var outputFile = "purchase_report" + "_" + currentdate;
...
//        var selected_val = document.querySelector('input[name="bank_book_radio"]:checked').value;
        ...
        doc.text(200, 20, "Details Report For Purchase");
...
//        var selected_val = document.querySelector('input[name="bank_book_radio"]:checked').value;
        ...
        docprint.document.write('<html><title>Details Purchase Report </title>');
        ...
        docprint.document.write('<p style="margin-left:80px">Details Purchase Report</p>');
