...
//        }
        ...
        if (navigator.appName == "Microsoft Internet Explorer") {
            ...
            var currentdate = d.getFullYear() + '-' +
                    ...
                    (('' + day).length < 2 ? '0' : '') + day;
            var outputFile = "customer_due_report" + "_" + currentdate;
...
//        var selected_val = document.querySelector('input[name="bank_book_radio"]:checked').value;
        ...
        doc.text(200, 20, "Details Report For Customer Due");
...
//        }
        ...
        docprint.document.write('<html><title>Details Report Of Customer Due</title>');
        ...
        docprint.document.write('<p style="margin-left:80px">Details Report for Customer Due</p>');
