...
//        }
        ...
        if (navigator.appName == "Microsoft Internet Explorer") {
            ...
            var currentdate = d.getFullYear() + '-' +
                    ...
                    (('' + day).length < 2 ? '0' : '') + day;
            var outputFile = "feed_report" + "_" + currentdate;
...
//        var selected_val = document.querySelector('input[name="feed_report_radio"]:checked').value;
        ...
        doc.text(200, 20, "Details Report For Feed");
...
//        var selected_val = document.querySelector('input[name="feed_report_radio"]:checked').value;
        ...
        docprint.document.write('<html><title style="font-size:12px;">Details Feed Report </title>');
        ...
        docprint.document.write('<p style="margin-left:80px">Details Feed Report</p>');
