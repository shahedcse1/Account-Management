        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        <form class="tasi-form" method="post" action="<?php echo site_url('report/dailyreport'); ?>">
                                        ...
                                        foreach ($dailydata as $datarow):
                                            ...
                                            <tr class=""><td><?php echo $datarow->accNo; ?></td>
                                                ...
                                                <td style="text-align: right"><?php
                                                    ...
                                                    ?></td>
                                                <td style="text-align: right"><?php echo $datarow->debitsum; ?></td>
                                                <td style="text-align: right"><?php echo $datarow->creditsum; ?></td>
                                                <td style="text-align: right"><?php
                                            ...
                                            ?>
                                        <tr>
                                            <td colspan="6"> No data found to display </td>
                                        </tr>
                                    <?php endif;
                                    ?>
                                </tbody>
