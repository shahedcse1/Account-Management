...
//        }
        ...
        if (navigator.appName == "Microsoft Internet Explorer") {
            ...
            var currentdate = d.getFullYear() + '-' +
                    ...
                    (('' + day).length < 2 ? '0' : '') + day;
            var outputFile = "daily_report" + "_" + currentdate;
...
//        var selected_val = document.querySelector('input[name="bank_book_radio"]:checked').value;
        ...
        doc.text(200, 20, "Details Daily Report");
...
//        }
        ...
        docprint.document.write('<html><title>Details Daily Report</title>');
        ...
        docprint.document.write('<p><h2>Details Daily Report </h2></p>');
