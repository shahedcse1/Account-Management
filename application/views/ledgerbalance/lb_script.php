...
<script type="text/javascript">
    ...
    $("#btnExport ").on('click', function(event) {
        ...
        if (navigator.appName == "Microsoft Internet Explorer") {
            ...
            var currentdate = d.getFullYear() + '-' +
                    ...
                    (('' + day).length < 2 ? '0' : '') + day;
            var outputFile = "ledger_balance_report" + currentdate;
    ...
    function generatePdf() {
        ...
        doc.text(200, 20, "Details Report For Ledger Balance");
    ...
    function Clickheretoprint()
    {
        ...
        docprint.document.write('<html><title>Details Report Of Ledger Balance</title>');
        docprint.document.write('<head><style>');
        docprint.document.write('table {border-collapse:collapse; background-color: #C0C0C0; width: 700px;}');
